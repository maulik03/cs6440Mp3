...
query.set("code", [
  'http://snomed.info/sct|44054006',   // Diabetes code
].join(","));
client.request("Condition?" + query).then(function(data) {
  if (data.entry == undefined) {
    getmoreInfo("This patient doesn't have Diabetes as per FHIR record!");
  }
});
